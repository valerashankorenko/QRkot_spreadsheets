...
async def create_charityproject(
    ...
    return await process_investment(
        session, await charityproject_crud.create(charityproject, session))
...
async def delete_charityproject(
    ...
    return await charityproject_crud.remove(check_amount(project), session)
